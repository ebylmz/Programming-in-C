...
{
    printf("find_weekday_of_data: TO BE IMPLEMENTED\n");
    return -1;
}
...
{
    printf("count_day_between_dates: TO BE IMPLEMENTED\n");
    return -1;
}
...
{
    printf("find_angle: TO BE IMPLEMENTED\n");
    return 0.0;
}
...
{
    printf("print_tabulated: TO BE IMPLEMENTED\n");
}
